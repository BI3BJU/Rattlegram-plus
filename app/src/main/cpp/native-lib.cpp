...
Java_com_bi3bju_rattlegram_1plus_MainActivity_createEncoder(   
	JNIEnv *,
	jobject,
	jint sampleRate) {
...
Java_com_bi3bju_rattlegram_1plus_MainActivity_destroyEncoder(   
	JNIEnv *,
	jobject) {
	delete encoder;
	encoder = nullptr;
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_bi3bju_rattlegram_1plus_MainActivity_produceEncoder(   
	JNIEnv *env,
	jobject,
...
extern "C" JNIEXPORT void JNICALL
Java_com_bi3bju_rattlegram_1plus_MainActivity_configureEncoder(   
	JNIEnv *env,
	jobject,
...
extern "C" JNIEXPORT void JNICALL
Java_com_bi3bju_rattlegram_1plus_MainActivity_destroyDecoder(   
	JNIEnv *,
	jobject) {
	delete decoder;
	decoder = nullptr;
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_bi3bju_rattlegram_1plus_MainActivity_createDecoder(   
	JNIEnv *,
	jobject,
	jint sampleRate) {
...
Java_com_bi3bju_rattlegram_1plus_MainActivity_fetchDecoder(   
	JNIEnv *env,
	jobject,
	jbyteArray JNI_payload) {
	jint status = -1;
...
extern "C" JNIEXPORT void JNICALL
Java_com_bi3bju_rattlegram_1plus_MainActivity_stagedDecoder(   
	JNIEnv *env,
	jobject,
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_bi3bju_rattlegram_1plus_MainActivity_feedDecoder(   
	JNIEnv *env,
	jobject,
	jshortArray JNI_audioBuffer,
	jint sampleCount,
...
extern "C" JNIEXPORT jint JNICALL
Java_com_bi3bju_rattlegram_1plus_MainActivity_processDecoder(   
	JNIEnv *,
	jobject) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_bi3bju_rattlegram_1plus_MainActivity_spectrumDecoder(   
	JNIEnv *env,
	jobject,
